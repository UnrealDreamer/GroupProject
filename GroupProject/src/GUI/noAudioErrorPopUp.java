...
public class noAudioErrorPopUp implements ActionListener {
	...
	public noAudioErrorPopUp()
	{
		frame=new JFrame("Word Creation Error");
		panel=new JPanel();
		errorStatement=new JLabel("   No Audio to accompany word. Please add audio and try Again.");
	...
	{
		noAudioErrorPopUp x=new noAudioErrorPopUp();
	}
