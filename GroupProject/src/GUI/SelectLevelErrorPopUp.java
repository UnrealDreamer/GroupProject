...
public class SelectLevelErrorPopUp implements ActionListener {
	...
	public SelectLevelErrorPopUp()
	{
		frame=new JFrame("Select Level Error");
		panel=new JPanel();
		errorStatement=new JLabel("Please select a level from the drop down menu");
	...
	{
		SelectLevelErrorPopUp x=new SelectLevelErrorPopUp();
	}
